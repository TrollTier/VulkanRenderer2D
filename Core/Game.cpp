...
Game::Game()
{
    ...
    textureIndices.push_back(m_renderer->loadTexture("../Assets/texture.jpg"));
    textureIndices.push_back(m_renderer->loadTexture("../Assets/Flame.png"));
    textureIndices.push_back(m_renderer->loadTexture("../Assets/wood_1.png"));
...
void Game::mouseButtonCallback(int button, int action, int mods)
{
    ...
    const auto object = m_world->addGameObject(
        glm::vec3(static_cast<float>(xpos), static_cast<float>(ypos), 0),
